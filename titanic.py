"""
This module contains functions and classes related to the Titanic dataset.
It includes data processing, analysis, and machine learning models for predicting 
survival based on passenger features.
"""
...
parser.add_argument(
    "--n_trees", type=float, default=20, help="Nombre d'arbre à calculer"
)
...
# calculons le score sur le dataset d'apprentissage et sur le dataset de test (10%
# du dataset d'apprentissage mis de côté)
